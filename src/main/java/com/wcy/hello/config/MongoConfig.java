 ...
 */
@Configuration
@EnableMongoRepositories(basePackages = "com.wcy.hello.repository.mongo", mongoTemplateRef = "mongodbTemp")
public class MongoConfig {
    ...
    @Bean
    public MongoDbFactory proto_factory(@Qualifier("mongodbConf") MongoProperties mongoProperties) {
        String uri = "mongodb://";
